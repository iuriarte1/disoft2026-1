...
public class SingleDebuffSkillEffect : StatusSkillEffect
{
    ...
    public SingleDebuffSkillEffect(Skill skill, Beast victim, IReadOnlyList<StatModifierType> effects, int baseRounds, int bpUsed, int roundsPerBp)
        : base(skill, effects, baseRounds, bpUsed, roundsPerBp) { _victim = victim; }
